      ...
      <div className=" w-3/12 bg-black absolute  center my-40 mx-auto right-0 left-0 p-8 bg-opacity-80 rounded-md py-14">
        ...
        <form>
          ...
          <input
            ...
            className="w-full h-12 p-6  bg-transparent border border-gray-600 m-4 ml-0 rounded-md bg-slate-950"
          />
          <input
            type="submit"
            className=" bg-red-600 text-white font-semibold w-full p-3 m-4 ml-0 rounded-md"
          />
        </form>
